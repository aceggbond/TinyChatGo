...
const webAccessCookieName = "tinychatgo_web_access"
...
func (s *Server) webAccessRequired(r *http.Request) bool {
	...
	if header := strings.TrimSpace(r.Header.Get("X-TinyChatGo-Access-Password")); header != "" &&
